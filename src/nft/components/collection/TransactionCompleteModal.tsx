...
import { BackArrowIcon, ChevronUpIcon, LightningBoltIcon, TwitterIcon, XdogeLogoIcon } from 'nft/components/icons'
            ...
            {showPurchasedModal && (
              ...
              >
                <Box className={styles.successModal} onClick={stopPropagation}>
                  <XdogeLogoIcon color={vars.color.pink400} width="36" height="36" className={styles.uniLogo} />
