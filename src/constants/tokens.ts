...
export const BASE_USDC = new Token(ChainId.BASE, '0x833589fcd6edb6e08f4c7c32d4f71b54bda02913', 6, 'USDC', 'USDC')
export const BASE_DAI = new Token(ChainId.BASE, '0x50c5725949a6f0c72e6c4a641f24049a917db0cb', 6, 'DAI', 'DAI')
